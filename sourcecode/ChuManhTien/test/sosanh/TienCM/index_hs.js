...
const { getTimeForProject, getLastKPIAndAvailableEmpsInTasks, reScheduleTasks, scheduleTasksWithAssetAndEmpTasks, getEmployeesCost, harmonySearch_Base}= require('../../../algorithm/hs_helper');
...
async function soSanhThuatToan() {
  ...
  for (let t = 0; t < 100; t++) {
    ...
    // Step 2
    testResult = harmonySearch_Base(HS_Arguments, job.tasks, employees, lastKPIs, kpiTarget, kpiOfEmployeesTarget, assetHasKPIWeight)
    // Step 3
  ...
  const filePath = './output/output_sosanh_hs_100.xlsx';
